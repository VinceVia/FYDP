...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.start_button.config(font=("Times", 30, 'bold'))
        ...
        self.stop_button.config(font=("Times", 30, 'bold'))
        ...
        self.EN_button.grid(sticky=E, row=4, column=1, padx=40)
        ...
        self.FR_button.grid(sticky=E, row=5, column=1, padx=40)
