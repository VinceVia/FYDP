...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.results_link.grid(row=2, columnspan=2)
        ...
        self.start_button.grid(sticky=W, row=3, column=0, padx=20, pady=40)
        ...
        self.stop_button.grid(sticky=E, row=3, column=1, padx=20, pady=40)
        ...
        self.previous_results.grid(sticky=W, row=4, column=0, padx=20)
        ...
        self.quit.grid(sticky=W, row=5, column=0, padx=20)
        ...
        self.EN_button.grid(sticky=E, row=4, column=1, padx=20)
        ...
        self.FR_button.grid(sticky=E, row=5, column=1, padx=20)
